---
layout: post
title: \[write-up\] pbctf2020 Corey's Coredump
tags: CTF
---
...
First, encrypted password2 stored in stack which can be found from gdb.

![gdb](/images/pbctf2020-corey/gdb.png)

And from current stack address, I audited all stack area in IDA by hand and finally got second password.
